...
'''
This script visualizes the data that is generated from calibration runs. This is used when determining
what the sensor limits for reasonable operation of the soft robot in the learning algorithm.

The first and only argument should be the path of the data generated by the sensor_calibration.py script

Please see -Thesis- for more information on how to properly use this script.
...
def plotXcal(x_data, y_data, xstdDev_data, ystdDev_data, robotName):
	...
	plt.xlabel('Actuation (0-100)mm - Right Actuator')
...
def plotYcal(x_data, y_data, xstdDev_data, ystdDev_data, robotName):
	...
	plt.xlabel('Actuation (0-100)mm - Left Actuator')
	plt.ylabel('Sensor Reading (0-1024) Right Actuator')
